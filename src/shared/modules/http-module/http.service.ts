...
export class HttpServiceBase {
  ...
  delete<T = any>(url: string): Promise<[Error | AxiosError, T]> {
    return this.wrap<T>(
      this.axiosInstance.delete.bind(this),
      url,
      this.axiosRequestConfig,
    );
  }
  head<T = any>(url: string): Promise<[Error | AxiosError, T]> {
    return this.wrap<T>(
      this.axiosInstance.head.bind(this),
      url,
      this.axiosRequestConfig,
    );
  }
  post<T = any, D = any>(
    ...
    return this.wrap<T>(
      this.axiosInstance.post.bind(this),
      url,
      data,
      this.axiosRequestConfig,
    );
  ...
  put<T = any, D = any>(
    ...
    return this.wrap<T>(
      this.axiosInstance.put.bind(this),
      url,
      data,
      this.axiosRequestConfig,
    );
  ...
  patch<T = any>(url: string, data: any): Promise<[Error | AxiosError, T]> {
    return this.wrap<T>(
      this.axiosInstance.patch.bind(this),
      url,
      data,
      this.axiosRequestConfig,
    );
